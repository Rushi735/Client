    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.ok) {
                    // CHANGE: Updated success message to reflect pending admin approval.
                    // Informs user that registration is submitted but requires approval before login.
                    alert('Registration submitted for admin approval. You will be able to log in once approved.');
